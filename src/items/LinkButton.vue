...
<template>
  <div class="relative w-fit">
    <a id="linkToResume" @click='focusAndBlur("linkToResume")' 
      ...
      before:h-11 before:absolute before:focus:hover:w-full before:transition-all before:ease-in-out before:duration-500"
      :href="props.link" :target="props.targetBlank ? 'blank' : ''" >
